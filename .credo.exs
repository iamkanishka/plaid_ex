    ...
    %{
      ...
      checks: %{
        enabled: [
          ...
          {Credo.Check.Readability.StrictModuleLayout, [order: ~w(moduledoc behaviour use import require alias)a]},
        ...
        disabled: [
          # We use TODO comments intentionally in early development
          {Credo.Check.Design.TagTODO, []},
          # We prefer explicit module docs even when minimal
          {Credo.Check.Readability.ModuleDoc, []}
        ]
      }
    }
